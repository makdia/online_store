 ...
 <div id="About" class="container-fluid" style="background:white;">
    <br>
      <div class="row ">
        ...
        <img src="{{asset('assets/img/about.png')}}" alt="" class="img-fluid" >
        </div>
        <div  align="center" class="col-md-8 wow animated flash slow">
            <h1 class="black-text" style="font-weight:bold;">Our Values</h1>
            ...
            <div class="row my-5" style="font-size:30px; font-family: 'Balsamiq Sans', cursive;">
              <div class="col-md-6" >
                    <ul align="left" style="list-style:none;">
                        <li><i class="fab fa-whmcs"></i> Quality Craftsmanship</li><br>
                        <li><i class="fab fa-whmcs"></i> Customer Satisfaction</li>
                    </ul>
              </div>
              <div class="col-md-6">
                    <ul align="left" style="list-style:none;">
                    <li><i class="fab fa-whmcs"></i> Style and Elegance</li><br>
                    <li><i class="fab fa-whmcs"></i> Affordability</li>
                  </ul>
              </div>
            </div>
              ...
              <div class="col-lg-5 d-flex align-items-stretch">
                <div align="left" class="info">
                  ...
                  <i class="fas fa-envelope"></i>
                    <h4>Email:</h4>
                    <p>makdiahussain81@gmail.com</p>
                  </div>

                  <div class="phone">
                  <i class="fas fa-phone"></i>
                    <h4>Call:</h4>
                    <p>Munzia : +11 1111111111</p>
                  </div>
