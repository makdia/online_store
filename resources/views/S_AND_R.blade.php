@extends('layout')
@section('title') Munzia - FAQ'S @endsection
...
<h1 align="center" class="black-text col-md-12" style="font-weight:bold;">Shipping & Returns</h1>
  ...
  <p align="center">Munzia will give more priority to the customer's happiness.We deliver the orders at the best quality with the best pricing</p>
